...
jobs_14 <- jobs_by_counties(14 ,jobs = green_jobs)

# 2013 and before BLS uses xls files instead of xlsx
jobs_13 <- jobs_by_counties(13, jobs = green_jobs, xlsx = FALSE)
jobs_12 <- jobs_by_counties(12, jobs = green_jobs, xlsx = FALSE)
jobs_11 <- jobs_by_counties(11, jobs = green_jobs, xlsx = FALSE)
jobs_10 <- jobs_by_counties(10, jobs = green_jobs, xlsx = FALSE)
jobs_09 <- jobs_by_counties('09',jobs = green_jobs, xlsx = FALSE)
jobs_08 <- jobs_by_counties('08', jobs = green_jobs, xlsx = FALSE)
jobs_07 <- jobs_by_counties('07', jobs = green_jobs, xlsx = FALSE)
jobs_06 <- jobs_by_counties('06', jobs = green_jobs, xlsx = FALSE)
jobs_05 <- jobs_by_counties('05', jobs = green_jobs, xlsx = FALSE)
